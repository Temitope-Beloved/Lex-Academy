    ...
    <div >
      <div className='flex justify-between h-[90vh] items-center mx-16 pt-7'>
        <div className='text-left teacking-wider  '>
          ...
          <button className='bg-secondary rounded-md text-white text-lg lg:text-2xl font-semibold  lg:p-4 hover:bg-white hover:text-secondary border-2 border-secondary ease-out duration-300'>Start learning now</button>
        </div>
